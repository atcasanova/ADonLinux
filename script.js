...
jQuery(function ($) {
    "use strict";
    if ($('#main').children('header.header').length) {
        $('#header-bg').insertAfter($('header.header'));
    }
});
...
var ThemeLightbox = (function ($) {
    ...
    return (function () {
        ...
        function showError(enable) {
            if (enable) {
                $(".lightbox-wrapper").append($('<div class="lightbox-error">Não é possível carregar o conteúdo pedido.<br/>Por favor tente mais tarde.</div>')
